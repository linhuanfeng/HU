package com.hu.health.community.aop;

import com.hu.health.community.config.dataSources.DataSourceContextHolder;
import com.hu.health.community.config.dataSources.DataSourceTypeEnum;
...
public class DataSourceAspect {
    ...
    @Pointcut("execution(* com.hu.health.community.dao.*.*(..))")
