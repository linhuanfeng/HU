package com.hu.health.consult.aop;

import com.hu.health.consult.config.dataSources.DataSourceContextHolder;
import com.hu.health.consult.config.dataSources.DataSourceTypeEnum;
...
public class DataSourceAspect {
    ...
    @Pointcut("execution(* com.hu.health.consult.dao.*.*(..))")
