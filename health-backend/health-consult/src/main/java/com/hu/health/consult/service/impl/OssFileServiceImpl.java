...
import com.hu.health.consult.utils.FileNameUtil;
...
public class OssFileServiceImpl {
    ...
    @Autowired
    private OSS ossClient;// 注入阿里云oss文件服务器客户端 sad
...
//            throw new HUException(BizCodeEnum.FILE_TYPE_EXCEPTION.getCode(),BizCodeEnum.FILE_TYPE_EXCEPTION.getMsg());
        }
